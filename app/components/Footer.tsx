          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link href="/" className="text-[#F7FAFC]/80 hover:text-white transition-colors duration-200">
                    Home
                  </Link>
                </li>
                <li>
                  <Link href="/about" className="text-[#F7FAFC]/80 hover:text-white transition-colors duration-200">
                    About Us
                  </Link>
                </li>
                <li>
                  <Link href="/services" className="text-[#F7FAFC]/80 hover:text-white transition-colors duration-200">
                    Services
                  </Link>
                </li>
                <li>
                  <Link href="/contact" className="text-[#F7FAFC]/80 hover:text-white transition-colors duration-200">
                    Contact
                  </Link>
                </li>
              </ul>
